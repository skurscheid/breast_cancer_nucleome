...
rule bwa_pe:
    """ runs alignment of fastq files in PE mode using bwa, modified parameters specific for HiC data"""
    conda:
    ...
    output:
        bam = "bwa/align/pe/{batch}/{sample}_{lane}_{replicate}.{end}.bam",
        metrics = "bwa/report/pe/{batch}/{sample}_{lane}_{replicate}.{end}.txt"
    shell:
        """
